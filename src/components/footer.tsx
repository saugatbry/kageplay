  ...
  return (
    <footer className="w-full bg-base-300 shadow-xl p-5 flex flex-col items-center space-y-5">
      ...
      <div className="flex space-x-5 items-center">
        <Link href="https://github.com/saugatbry" target="_blank">
          <svg
        ...
        <Link href="https://dsc.gg/kageplay" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25"
            height="25"
        ...
        <Link href="https://instagram.com/psyflowz" target="_blank">
          <InstagramLogoIcon width="25" height="25" />
        </Link>
      </div>
      <p className="text-xs text-gray-500 flex items-center gap-2">
        Need help?{" "}
        <Link href="https://instagram.com/psyflowz" target="_blank" className="text-blue-400 hover:text-blue-300">
          DM psyflowz
        </Link>
        {" / "}
        <Link href="https://dsc.gg/kageplay" target="_blank" className="text-indigo-400 hover:text-indigo-300">
          Discord
        </Link>
      </p>
      <Link
